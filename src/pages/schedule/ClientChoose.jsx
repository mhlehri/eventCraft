const ClientChoose = () => {
  return (
    <div className="bg-[#f5f5f5]">
      <div className="max-w-screen-xl py-10 px-6 lg:px-8 lg:py-14 mx-auto ">
        <div className="grid items-center lg:grid-cols-12 gap-6 ">
          <div className="lg:col-span-4 mx-auto ">
            <div className="lg:pr-6 xl:pr-12">
              <p className="text-6xl font-bold leading-10 text-black">
                92%
          ...
          <div className=" lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-left-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:dark:bg-gray-700">
            <div className="flex justify-between ">
              <div>
                <p className="text-3xl font-semibold text-black">99.95%</p>
                <p className="mt-1 text-gray-500">in fulfilling orders</p>
              </div>

              <div>
                <p className="text-3xl font-semibold text-black">2,000+</p>
                <p className="mt-1 text-gray-500">partner with Preline</p>
              </div>

              <div>
                <p className="text-3xl font-semibold text-black">85%</p>
